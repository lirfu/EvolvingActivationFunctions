...
//                .add(new InputNode())
    ...
    private static final Experiment[] experiments = {
            new Experiment("03_relu_30_30_overfit_normfeat_shflb", new int[]{30, 30}, new TrainParams.Builder()
                    ...
                    .epochs_num(50)
                    .learning_rate(1e-3))
//            new Experiment("02_relu_50_50_overfit_normfeat", new int[]{50, 50}, new TrainParams.Builder()
//                    .batch_size(32)
//                    .normalize_features(true)
//                    .epochs_num(100)
//                    .learning_rate(1e-3))
//            ,
//            new Experiment("01_relu_30_50_30_overfit_normfeat_shflb", new int[]{30, 50, 30}, new TrainParams.Builder()
//                    .batch_size(32)
//                    .normalize_features(true)
//                    .shuffle_batches(true)
//                    .epochs_num(100)
//                    .learning_rate(1e-3)),
//            new Experiment("13_relu_30_50_30_l2_long", new int[]{30, 50, 30}, new TrainParams.Builder()
//                    .batch_size(32)
//                    .normalize_features(true)
//                    .shuffle_batches(true)
//                    .epochs_num(100)
...
//                    .learning_rate(1e-3)
//                    .regularization_coef(1e-4)),
//            new Experiment("relu_30_30_30", new int[]{30, 30, 30}, new TrainParams.Builder()
//                    .batch_size(64)
//                    .normalize_features(true)
//                    .shuffle_batches(true)
//                    .epochs_num(50)
