 ...
 */
public class Modifier extends APipe<DataPair, DataPair> {
     ...
     */
    public Modifier(@NotNull APipe<?, DataPair> parent) {
     ...
     */
    public Modifier(@NotNull APipe<?, DataPair> parent, @NotNull IModifier[] data_modifiers) {
        parent_ = parent;
...
//        }
     ...
     */
    private Modifier(@NotNull APipe<?, DataPair> parent, @NotNull IModifier[] data_modifiers, DataPair[] data) {
        parent_ = parent;
        data_modifiers_ = data_modifiers;
        data_ = data;
    }
...
//        modifier.apply(data_);
    ...
    public Modifier clone() {
        return new Modifier(parent_, data_modifiers_, data_);
    }
}
