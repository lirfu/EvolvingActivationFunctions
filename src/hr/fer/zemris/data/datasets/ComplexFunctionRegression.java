...
public class ComplexFunctionRegression extends APipe<Object, DataPair> implements IDescriptableDS {
    ...
    public ComplexFunctionRegression(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            data_[i] = new DataPair(new float[]{xx, i, 5 * xx * i}, (float) (0.2f * Math.sin(xx) + 0.2f * Math.sin(2 * xx + Math.PI / 7) + 0.5f));
        }
    }
