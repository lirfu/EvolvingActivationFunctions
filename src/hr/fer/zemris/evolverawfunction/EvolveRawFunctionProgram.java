package hr.fer.zemris.evolverawfunction;
...
public class EvolveRawFunctionProgram {
    ...
    private static class RawEvaluator extends AEvaluator<DerivableSymbolicTree> {
