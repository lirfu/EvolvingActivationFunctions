...
\caption{Prikazan je utjecaj odabira početne točke na kvalitetu pronađenog optimuma. Loše odabrana točka (desno) može zaustaviti spust.}
...
\caption{Prikazan je utjecaj momenta na savladavanje platoa i izbočina. Debljina kružnice označava veličinu momenta.}
\label{fig:visoravan}
\end{figure}
...
U rezultatima pojavljuju se periodične funkcije. Stoga se u ovom poglavlju navode neka njihova svojstva.
...
Funkcija je tvrda inačica sigmoide nastala Taylor-ovim razvojem linearnog dijela sigmoide oko $0$. Funkcija je .... \citep{hardsigm}
