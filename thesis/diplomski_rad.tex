...
\todo{Xavier}
\todo{postoji i nenadzirana inicijalizacija sloj-po-sloj RBM \citep{relu6} ili autoenkoderom, ali u kontekstu evolucije je preskupa}
...
f'(x) =
\begin{cases}
cos(x), \quad x \in [-\frac{\pi}{2},\frac{\pi}{2}] \\
0, \quad \otherwise
\end{cases}
\end{split}
\end{equation}
