...
\zahvala{
\paragraph{}
Zahvaljujem mentoru prof. dr. sc. Domagoju Jakoboviću na svoj pomoći koju mi je pružio tijekom studiranja. 

\paragraph{}
Posebno zahvaljujem Karlu Kneževiću, mag. ing., na nesebičnoj podršci i savjetovanju pri razvoju i izradi diplomskog rada.

\paragraph{}
Zahvaljujem svojoj obitelji na razumijevanju, potpori i ljubavi tijekom čitavog školovanja te strpljenju u kasnim noćnim satima.
}
...
\subsection{Predikcija okteta na DPAv4}
...
\subsection{Predikcija Hammingove težine na DPAv4}
...
\subsection{Predikcija Hammingove težine na DPAv4}
Pri predikciji HAmmingove težine na DPAv4 podatkovnom skupu najbolje pronađene aktivacijske funkcije daju rezultate ekvivalentne najboljem rezultatu prethodnih eksperimenata. Najbolje pronađene funkcije spomenute su u tablici \ref{tab:dpav4_top5}.
...
\chapter{Zaključak}
Potpuno povezane umjetne neuronske mreže korištene su za klasifikacijski zadatak predviđanja kriptografskog ključa iz naponskih mjerenja kriptografskog uređaja. Za mjerenja je korišten podatkovni skup DPAv4 s reduciranim brojem ulaznih značajki. Performanse mreža uspoređene su na nekoliko odabira arhitekture i aktivacijske funkcije te je korišten postupak izgradnje aktivacijske funkcije genetskim programiranjem.

Pokazuje se da odabir aktivacijske funkcije utječe na performanse neuronske mreže. Najboljom funkcijom pokazala se sinusoida, rijetko korištena u modernoj literaturi dubokog učenja. Izgradnjom aktivacijskih funkcija pronađena su mala poboljšanja u svojstvu generalizacije mreže.
...
Buduće istraživanje uključuje detaljniju analizu dobrih rezultata koje ostvaruju periodične aktivacijske funkcije na podatkovnim skupovima DPAv4 te ispitivanje učinkovitosti algoritma s tabu listom na problemima simboličke regresije.
