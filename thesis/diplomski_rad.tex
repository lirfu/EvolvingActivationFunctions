...
\todoimg{IntelliJ generirna UML paketa utils.threading}

\section{Logiranje}
\todo{kaj sve imaš i kak se koristi}
\todoimg{IntelliJ generirna UML paketa utils.logging}
...
\centering
\caption{Najbolja kombinacija hiperparametara za izlazne funkcije na različitim arhitekturama. Vrijednosti u ćelijama označavaju kombinaciju hiperparametara navedenu u tablici \ref{tab:hp_256_comb}}
\label{fig:greedy_256_acc}
\end{figure}
