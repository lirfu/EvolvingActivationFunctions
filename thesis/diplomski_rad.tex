...
\def\todoeq#1{\textcolor{red}{\begin{equation}\text{\big[EQ: \textit{#1}\big]}\end{equation}}}
...
Za odabir izlazne funkcije ne postoji jasno pravilo. U praksi se odabiru empirijski po pokazanim rezultatima i brzinom (te implementacijskom podrškom), s preferencijom onih koje imaju neku teorijsku podlogu. U radu \citet{learnable_func} predstavljen je pokušaj automatske izgradnje izlazne funkcije gradijentnim spustom, no ... . U radu \citet{golden_func} autori koriste simboličku regresiju kako bi izgradili dvodjelnu funkciju, sa zasebnom komponentom u negativnoj i pozitivnoj domeni. Rezultat pretrage je funkcija \textit{Swish} \ref{func:swish} koja se pokazala vrlo dobrom na nekoliko arhitektura i podatkovnih skupova.
