...
Ulazne funkcije temeljene na udaljenosti vektora koriste se u radijalnim baznim funkcijama...\todo{*Spomeni RBF} 
...
\begin{figure}[H]
\includegraphics[width=.9\textwidth]{Softmax.pdf}
\centering
...
\todo{Tablica}
\todo{Komentar}
\todoimg{boxplot usporedba po tabu veličini}
